...
public class SQLiteDatabaseContext : DbContext
{
    ...
    public void CreateComment(string content, int commentId, int userId, string createdAt) {
    ...
    public void CreateArticle(string title, string content, int authorId, string createdAt) {
